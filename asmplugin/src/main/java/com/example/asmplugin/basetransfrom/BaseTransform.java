package com.example.asmplugin.basetransfrom;
...
import com.example.asmplugin.basetransfrom.asm.ClassLoaderHelper;
import com.example.asmplugin.basetransfrom.concurrent.Schedulers;
import com.example.asmplugin.basetransfrom.concurrent.Worker;
...
public abstract class BaseTransform extends Transform {
    ...
    protected BaseModify bytecodeWeaver;
    ...
    public BaseTransform(Project project) {
        ...
        this.bytecodeWeaver = getBaseModify();
    }

    public abstract BaseModify getBaseModify();
